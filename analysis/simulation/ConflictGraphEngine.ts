...
export class ConflictGraphEngine extends BaseCourtAssignmentEngine implements ICourtAssignmentEngine {
  ...
  readonly name = 'Conflict Graph';
  readonly description = 'Deterministic greedy construction using conflict graph modeling. Systematically builds assignments by selecting players that minimize total conflict.';
