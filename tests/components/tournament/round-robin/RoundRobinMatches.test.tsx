...
describe('RoundRobinMatches', () => {
  ...
  describe('rendering', () => {
    ...
    it('current round is expanded by default', () => {
      render(<RoundRobinMatches tournament={threeMatchSingles} onMatchResult={onMatchResult} />);
  ...
  describe('score modal', () => {
    it('clicking team 1 opens modal with winnerTeam=1', async () => {
    ...
    it('confirming with scores calls onMatchResult with correct args', async () => {
      const user = userEvent.setup();
      render(<RoundRobinMatches tournament={threeMatchSingles} onMatchResult={onMatchResult} />);
  ...
  describe('completed match', () => {
    it('clicking the current winner clears the result', async () => {
      const user = userEvent.setup();
      const tournament = makeTournament([makeMatch('m1', 1, teamA, teamB, 1)], [teamA, teamB]);
